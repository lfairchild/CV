...
\item{\cventry{2015--present}{Master of Science, Earth and Planetary
    Science}{University of California, Berkeley}{Berkeley, CA}{}{Thesis:
\textit{The end of Midcontinent Rift magmatism and the paleogeography of
Laurentia}}\vspace{5pt}

\item{\cventry{2011--2015}{Bachelor of Arts, Geology (Honors)}{Carleton College}{Northfield,
    MN}{\textit{cum laude}}{Thesis: \textit{High temperature emplacement of clastic breccia dikes and implications for the development and magnetization of impact craters}}}  % arguments 3 to 6 can be left empty
...
\begin{itemize}
    ...
    \item \textbf{Programming and Markup Languages:} Proficient in Python,
        {\fontfamily{cmr}\selectfont\LaTeX}, Jupyter notebooks, HTML; some
